...
# Your program should accept as its first argument a path to a filename. The input file contains T lines. 
# Each line is a test case represented by a sequence of integers L, where each integer is N, separated by a whitespace. E.g
...
def compressedSequence(filepath):
	f = open(filepath, "r")
...
compressedSequence("compressedSequence.txt")